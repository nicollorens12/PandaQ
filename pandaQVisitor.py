...
class pandaQVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by pandaQParser#selectItemStar.
    def visitSelectItemStar(self, ctx:pandaQParser.SelectItemStarContext,df):
        return df


    # Visit a parse tree produced by pandaQParser#selectItemColumnNameList.
    def visitSelectItemColumnNameList(self, ctx:pandaQParser.SelectItemColumnNameListContext,df):
